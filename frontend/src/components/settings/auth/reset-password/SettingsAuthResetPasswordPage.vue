<template>
    <div class="form">
        ...
        <v-text-field
            ...
            variant="solo"
            type="email"
            v-model="authStore.$state.resetForm.email"
            :rules="[requiredValid, mailValid]"
        ></v-text-field>
        <v-btn v-if="validationResult()" type="submit" @click="handleResetPassword"
            >パスワードのリセットを希望する</v-btn
        >
...
export default defineComponent({
    ...
    name: 'SettingsAuthResetPassword',
    setup() {
